let darkwhite = document.getElementById("switch")
let firsicon = document.getElementById("icon-1")
...
function checkbodycolor() {
    if(localStorage.getItem("Theme") === "Black") {
        ...
        firsicon.innerHTML = 
        `<svg height="23" width="23" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
